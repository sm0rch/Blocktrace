...
CREATE TABLE [dbo].[BILLING_DETAIL] (
    ...
    [tx_id] NVARCHAR(1000) NOT NULL,
    [flat_fee] DECIMAL(18,2) NOT NULL CONSTRAINT [BILLING_DETAIL_flat_fee_df] DEFAULT 0,
    [logistics_fee] DECIMAL(18,2) NOT NULL CONSTRAINT [BILLING_DETAIL_logistics_fee_df] DEFAULT 0,
    [tax_amount] DECIMAL(18,2) NOT NULL CONSTRAINT [BILLING_DETAIL_tax_amount_df] DEFAULT 0,
    [total_amount] DECIMAL(18,2) NOT NULL CONSTRAINT [BILLING_DETAIL_total_amount_df] DEFAULT 0,
    [invoice_url] NVARCHAR(1000),
    [refund_amount] DECIMAL(18,2) NOT NULL CONSTRAINT [BILLING_DETAIL_refund_amount_df] DEFAULT 0,
...
CREATE TABLE [dbo].[RESOLUTION] (
    ...
    [refund_amount] DECIMAL(18,2) NOT NULL CONSTRAINT [RESOLUTION_refund_amount_df] DEFAULT 0,
